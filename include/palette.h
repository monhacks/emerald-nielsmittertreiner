...
struct PaletteFadeControl
{
    ...
    struct BlendSettings *bld0; // These three are only used for TOD blending
...
bool8 BeginTimeOfDayPaletteFade(u32, s8 delay, u8 startY, u8 targetY, struct BlendSettings *, struct BlendSettings *, u16 weight, u16 color);
...
void BlendPalettesFine(u32 selectedPalettes, u16 *src, u16 *dest, u32 coeff, u32 color);
