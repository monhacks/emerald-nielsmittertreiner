...
extern const u8 gText_HealthboxModeStatic[];
extern const u8 gText_HealthboxModeMove[];
...
extern const u8 gText_HealthboxMode[];
...
extern const u8 gText_Birch_YourePlayerMale[];
extern const u8 gText_Birch_YourePlayerFemale[];
