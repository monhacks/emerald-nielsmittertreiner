...
#define HEAL_LOCATION_SUNSET_TOWN 23
#define HEAL_LOCATION_CEDARRED_TOWN 24
#define HEAL_LOCATION_FIRWEALD_CITY 25
#define HEAL_LOCATION_MURENA_CITY 26
#define HEAL_LOCATION_LITOR_TOWN 27
#define HEAL_LOCATION_NAVIRE_TOWN 28
