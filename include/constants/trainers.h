...
#define TRAINER_PIC_AIRLOCK_GRUNT_F           93
#define TRAINER_PIC_TOURNAMENT_MASTER_PHYLLOS 94
...
#define TRAINER_CLASS_TEAM_AIRLOCK        0x42
#define TRAINER_CLASS_TOURNAMENT_MASTER   0x43
