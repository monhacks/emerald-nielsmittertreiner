...
extern const u8 TentacoolSkewer_EventScript_ItemUseTentacoolSkewer[];
...
extern const u8 EventScript_ClosedFirwealdDoor[];
extern const u8 FishermanFerry_EventScript_ResetFerryLocation[];
