...
{
    if (gSaveBlock2Ptr->inGameClock.hours >= 20 || gSaveBlock2Ptr->inGameClock.hours < 4)
        return gTimeOfDay = TIME_OF_DAY_NIGHT;
    else if (gSaveBlock2Ptr->inGameClock.hours >= 10 && gSaveBlock2Ptr->inGameClock.hours < 20)
