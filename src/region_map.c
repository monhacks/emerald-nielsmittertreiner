...
{
    {MAPSEC_UNDERWATER_105,             MAPSEC_ROUTE_405},
    {MAPSEC_UNDERWATER_124,             MAPSEC_ROUTE_424},
    #ifdef BUGFIX
    {MAPSEC_UNDERWATER_125,             MAPSEC_ROUTE_425},
    #else
    {MAPSEC_UNDERWATER_125,             MAPSEC_ROUTE_429}, // BUG: Map will incorrectly display the name of Route 129 when diving on Route 125 (for Marine Cave only)
    #endif
    {MAPSEC_UNDERWATER_126,             MAPSEC_ROUTE_426},
    {MAPSEC_UNDERWATER_127,             MAPSEC_ROUTE_427},
    {MAPSEC_UNDERWATER_128,             MAPSEC_ROUTE_428},
    {MAPSEC_UNDERWATER_129,             MAPSEC_ROUTE_429},
    {MAPSEC_UNDERWATER_SOOTOPOLIS,      MAPSEC_SOOTOPOLIS_CITY},
    {MAPSEC_UNDERWATER_SEAFLOOR_CAVERN, MAPSEC_ROUTE_428},
    {MAPSEC_AQUA_HIDEOUT,               MAPSEC_LILYCOVE_CITY},
    {MAPSEC_AQUA_HIDEOUT_OLD,           MAPSEC_LILYCOVE_CITY},
    {MAPSEC_MAGMA_HIDEOUT,              MAPSEC_ROUTE_412},
    {MAPSEC_UNDERWATER_SEALED_CHAMBER,  MAPSEC_ROUTE_434},
    {MAPSEC_PETALBURG_WOODS,            MAPSEC_ROUTE_404},
    {MAPSEC_JAGGED_PASS,                MAPSEC_ROUTE_412},
    {MAPSEC_MT_PYRE,                    MAPSEC_ROUTE_422},
    {MAPSEC_SKY_PILLAR,                 MAPSEC_ROUTE_431},
    {MAPSEC_MIRAGE_TOWER,               MAPSEC_ROUTE_411},
    {MAPSEC_TRAINER_HILL,               MAPSEC_ROUTE_411},
    {MAPSEC_DESERT_UNDERPASS,           MAPSEC_ROUTE_414},
    {MAPSEC_ALTERING_CAVE,              MAPSEC_ROUTE_403},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_ROUTE_403},
    {MAPSEC_ABANDONED_SHIP,             MAPSEC_ROUTE_408},
...
{
    [ABNORMAL_WEATHER_ROUTE_114_NORTH - 1] = MAPSEC_ROUTE_414,
    [ABNORMAL_WEATHER_ROUTE_114_SOUTH - 1] = MAPSEC_ROUTE_414,
    [ABNORMAL_WEATHER_ROUTE_115_WEST  - 1] = MAPSEC_ROUTE_415,
    [ABNORMAL_WEATHER_ROUTE_115_EAST  - 1] = MAPSEC_ROUTE_415,
    [ABNORMAL_WEATHER_ROUTE_116_NORTH - 1] = MAPSEC_ROUTE_416,
    [ABNORMAL_WEATHER_ROUTE_116_SOUTH - 1] = MAPSEC_ROUTE_416,
    [ABNORMAL_WEATHER_ROUTE_118_EAST  - 1] = MAPSEC_ROUTE_418,
    [ABNORMAL_WEATHER_ROUTE_118_WEST  - 1] = MAPSEC_ROUTE_418,
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_ROUTE_405,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_ROUTE_405,
    [ABNORMAL_WEATHER_ROUTE_125_WEST  - 1] = MAPSEC_ROUTE_425,
    [ABNORMAL_WEATHER_ROUTE_125_EAST  - 1] = MAPSEC_ROUTE_425,
    [ABNORMAL_WEATHER_ROUTE_127_NORTH - 1] = MAPSEC_ROUTE_427,
    [ABNORMAL_WEATHER_ROUTE_127_SOUTH - 1] = MAPSEC_ROUTE_427,
    [ABNORMAL_WEATHER_ROUTE_129_WEST  - 1] = MAPSEC_ROUTE_429,
    [ABNORMAL_WEATHER_ROUTE_129_EAST  - 1] = MAPSEC_ROUTE_429
};
...
{
    {MAP_GROUP(SUNSET_TOWN), MAP_NUM(SUNSET_TOWN), HEAL_LOCATION_SUNSET_TOWN},
    {MAP_GROUP(CEDARRED_TOWN), MAP_NUM(CEDARRED_TOWN), HEAL_LOCATION_CEDARRED_TOWN},
    {MAP_GROUP(FIRWEALD_CITY), MAP_NUM(FIRWEALD_CITY), HEAL_LOCATION_FIRWEALD_CITY},
    {MAP_GROUP(MURENA_CITY), MAP_NUM(MURENA_CITY), HEAL_LOCATION_MURENA_CITY},
    {MAP_GROUP(LITOR_TOWN), MAP_NUM(LITOR_TOWN), HEAL_LOCATION_LITOR_TOWN},
    {MAP_GROUP(NAVIRE_TOWN), MAP_NUM(NAVIRE_TOWN), HEAL_LOCATION_NAVIRE_TOWN},
    ...
    {MAP_GROUP(ROUTE101), MAP_NUM(ROUTE101), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE102), MAP_NUM(ROUTE102), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE103), MAP_NUM(ROUTE103), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE104), MAP_NUM(ROUTE104), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE105), MAP_NUM(ROUTE105), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE106), MAP_NUM(ROUTE106), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE107), MAP_NUM(ROUTE107), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE108), MAP_NUM(ROUTE108), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE109), MAP_NUM(ROUTE109), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE110), MAP_NUM(ROUTE110), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE111), MAP_NUM(ROUTE111), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE112), MAP_NUM(ROUTE112), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE113), MAP_NUM(ROUTE113), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE114), MAP_NUM(ROUTE114), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE115), MAP_NUM(ROUTE115), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE116), MAP_NUM(ROUTE116), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE117), MAP_NUM(ROUTE117), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE118), MAP_NUM(ROUTE118), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE119), MAP_NUM(ROUTE119), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE120), MAP_NUM(ROUTE120), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE121), MAP_NUM(ROUTE121), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE122), MAP_NUM(ROUTE122), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE123), MAP_NUM(ROUTE123), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE124), MAP_NUM(ROUTE124), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE125), MAP_NUM(ROUTE125), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE126), MAP_NUM(ROUTE126), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE127), MAP_NUM(ROUTE127), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE128), MAP_NUM(ROUTE128), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE129), MAP_NUM(ROUTE129), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE130), MAP_NUM(ROUTE130), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE131), MAP_NUM(ROUTE131), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE132), MAP_NUM(ROUTE132), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE133), MAP_NUM(ROUTE133), HEAL_LOCATION_NONE},
    {MAP_GROUP(ROUTE134), MAP_NUM(ROUTE134), HEAL_LOCATION_NONE}
};
...
bool8 LoadRegionMapGfx(void)
{
    ...
    case 1:
        if (sRegionMap->bgManaged)
        {
            if (!FreeTempTileDataBuffersIfPossible())
                DecompressAndCopyTileDataToVram(sRegionMap->bgNum, sRegionMapBg_TilemapLZ, 0, 0, 0);
        }
        else
        {
    ...
    case 2:
        if (!FreeTempTileDataBuffersIfPossible())
            LoadPalette(sRegionMapBg_Pal, BG_PLTT_ID(3), PLTT_SIZE_4BPP);
        break;
    case 3:
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    {
    case MAPSEC_ROUTE_414:
        if (y != 0)
            x = 0;
        break;
    case MAPSEC_ROUTE_426:
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_ROUTE124:
        sRegionMap->mapSecId = MAPSEC_ROUTE_424;
        break;
    case SS_TIDAL_LOCATION_ROUTE131:
        sRegionMap->mapSecId = MAPSEC_ROUTE_431;
        break;
    default:
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_SUNSET_TOWN:
        return FlagGet(FLAG_VISITED_SUNSET_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CEDARRED_TOWN:
        return FlagGet(FLAG_VISITED_CEDARRED_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_FIRWEALD_CITY:
        return FlagGet(FLAG_VISITED_FIRWEALD_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MURENA_CITY:
        return FlagGet(FLAG_VISITED_MURENA_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LITOR_TOWN:
        return FlagGet(FLAG_VISITED_LITOR_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_NAVIRE_TOWN:
        return FlagGet(FLAG_VISITED_NAVIRE_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_SUNSET_TOWN;
    for (mapSecId = MAPSEC_SUNSET_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
