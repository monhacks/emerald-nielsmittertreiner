...
static const u8 sRivalAvatarGfxIds[][2] =
{
    ...
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_PLAYER_MALE_UNDERWATER,   OBJ_EVENT_GFX_MAY_UNDERWATER},
...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_PLAYER_MALE_NORMAL,     OBJ_EVENT_GFX_MAY_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_PLAYER_MALE_MACH_BIKE,  OBJ_EVENT_GFX_MAY_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,      OBJ_EVENT_GFX_MAY_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_PLAYER_MALE_SURFING,    OBJ_EVENT_GFX_MAY_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_PLAYER_MALE_UNDERWATER, OBJ_EVENT_GFX_MAY_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_PLAYER_MALE_FIELD_MOVE, OBJ_EVENT_GFX_MAY_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_BRENDAN_FISHING,        OBJ_EVENT_GFX_MAY_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_BRENDAN_WATERING,       OBJ_EVENT_GFX_MAY_WATERING},
};
...
u16 unref_GetRivalAvatarGenderByGraphicsId(u8 gfxId)
{
    switch (gfxId)
    {
