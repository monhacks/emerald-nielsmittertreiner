...
static const u8 sRivalAvatarGfxIds[][2] =
{
    ...
    {OBJ_EVENT_GFX_PLAYER_MALE_UNDERWATER,   OBJ_EVENT_GFX_MAY_UNDERWATER},
...
{
    {OBJ_EVENT_GFX_PLAYER_MALE_NORMAL,     OBJ_EVENT_GFX_MAY_NORMAL},
    {OBJ_EVENT_GFX_PLAYER_MALE_MACH_BIKE,  OBJ_EVENT_GFX_MAY_MACH_BIKE},
    {OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,      OBJ_EVENT_GFX_MAY_ACRO_BIKE},
    {OBJ_EVENT_GFX_PLAYER_MALE_SURFING,    OBJ_EVENT_GFX_MAY_SURFING},
    {OBJ_EVENT_GFX_PLAYER_MALE_UNDERWATER, OBJ_EVENT_GFX_MAY_UNDERWATER},
    {OBJ_EVENT_GFX_PLAYER_MALE_FIELD_MOVE, OBJ_EVENT_GFX_MAY_FIELD_MOVE},
    {OBJ_EVENT_GFX_BRENDAN_FISHING,        OBJ_EVENT_GFX_MAY_FISHING},
    {OBJ_EVENT_GFX_BRENDAN_WATERING,       OBJ_EVENT_GFX_MAY_WATERING},
};
