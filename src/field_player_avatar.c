...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_RIVAL_MALE_NORMAL,      OBJ_EVENT_GFX_RIVAL_FEMALE_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_RIVAL_MALE_MACH_BIKE,   OBJ_EVENT_GFX_RIVAL_FEMALE_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_RIVAL_MALE_ACRO_BIKE,   OBJ_EVENT_GFX_RIVAL_FEMALE_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_RIVAL_MALE_SURFING,     OBJ_EVENT_GFX_RIVAL_FEMALE_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_PLAYER_MALE_UNDERWATER, OBJ_EVENT_GFX_PLAYER_FEMALE_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_RIVAL_MALE_FIELD_MOVE,  OBJ_EVENT_GFX_RIVAL_FEMALE_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_PLAYER_MALE_FISHING,     OBJ_EVENT_GFX_PLAYER_FEMALE_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_PLAYER_MALE_WATERING,    OBJ_EVENT_GFX_PLAYER_FEMALE_WATERING}
};

static const u8 sPlayerAvatarGfxIds[][2] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_PLAYER_MALE_NORMAL,     OBJ_EVENT_GFX_PLAYER_FEMALE_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_PLAYER_MALE_MACH_BIKE,  OBJ_EVENT_GFX_PLAYER_FEMALE_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_PLAYER_MALE_ACRO_BIKE,  OBJ_EVENT_GFX_PLAYER_FEMALE_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_PLAYER_MALE_SURFING,    OBJ_EVENT_GFX_PLAYER_FEMALE_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_PLAYER_MALE_UNDERWATER, OBJ_EVENT_GFX_PLAYER_FEMALE_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_PLAYER_MALE_FIELD_MOVE, OBJ_EVENT_GFX_PLAYER_FEMALE_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_PLAYER_MALE_FISHING,    OBJ_EVENT_GFX_PLAYER_FEMALE_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_PLAYER_MALE_WATERING,   OBJ_EVENT_GFX_PLAYER_FEMALE_WATERING},
};
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_PLAYER_MALE_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_PLAYER_MALE_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_PLAYER_MALE_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_PLAYER_MALE_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_PLAYER_MALE_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_PLAYER_FEMALE_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_PLAYER_FEMALE_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_PLAYER_FEMALE_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_PLAYER_FEMALE_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_PLAYER_FEMALE_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
u16 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_PLAYER_FEMALE_NORMAL:
    case OBJ_EVENT_GFX_PLAYER_FEMALE_MACH_BIKE:
    case OBJ_EVENT_GFX_PLAYER_FEMALE_ACRO_BIKE:
    case OBJ_EVENT_GFX_PLAYER_FEMALE_SURFING:
    case OBJ_EVENT_GFX_PLAYER_FEMALE_FIELD_MOVE:
    case OBJ_EVENT_GFX_PLAYER_FEMALE_UNDERWATER:
    case OBJ_EVENT_GFX_PLAYER_FEMALE_FISHING:
    case OBJ_EVENT_GFX_PLAYER_FEMALE_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
