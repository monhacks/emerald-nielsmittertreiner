...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_LANTERN_LIGHT]                     = TILE_FLAG_UNUSED,
    ...
    [MB_FIRWEALD_CLOSED_DOOR]              = TILE_FLAG_UNUSED,
    ...
    [MB_SIDEWAYS_WARP]                     = TILE_FLAG_UNUSED,
...
bool8 MetatileBehavior_IsLanternLight(u8 metatileBehavior)
{
