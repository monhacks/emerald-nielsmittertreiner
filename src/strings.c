...
const u8 gText_MainMenuMysteryEventsGift[] = _("EVENTS/GIFT");
...
const u8 gText_SaveFileOutdated[] = _("Your save file is for an older\nversion of VANADIUM.\pThe attempt to update your\nsave file has failed.\pPlease report this to BSBOB at\nthe VANADIUM Discord server.");
const u8 gText_SaveFileUpdated[] = _("Your save file is for an older\nversion of VANADIUM.\pYour save file will be updated.\pThese changes will be applied\nthe next time you save.\pPlease back up your old save file\nif you wish to keep it.");
const u8 gText_No1MSubCircuit[] = _("The 1M sub-circuit has not\nbeen installed.");
...
const u8 gText_ClockMode12Hour[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}12 HOUR");
const u8 gText_ClockMode24Hour[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}24 HOUR");
