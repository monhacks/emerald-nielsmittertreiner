...
const u8 gText_HealthboxMode[] = _("HEALTHBOX MODE");
...
const u8 gText_HealthboxModeStatic[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}STATIC");
const u8 gText_HealthboxModeMove[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MOVE");
