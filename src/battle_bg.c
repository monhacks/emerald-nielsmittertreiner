...
void LoadBattleMenuWindowGfx(void)
{
    ...
    LoadCompressedPalette(gBattleWindowTextPalette, 0xC0, 0x20);
    LoadCompressedPalette(gBattleWindowTextPalette, 0xD0, 0x20);
    LoadCompressedPalette(gBattleWindowTextPalette, 0xE0, 0x20);
...
void DrawMainBattleBackground(void)
{
    ...
    else
    {
        if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
        {
            ...
            if (trainerClass == TRAINER_CLASS_LEADER || trainerClass == TRAINER_CLASS_TOURNAMENT_MASTER)
            {
                LZDecompressVram(gBattleTerrainTiles_Building, (void*)(BG_CHAR_ADDR(2)));
                LZDecompressVram(gBattleTerrainTilemap_Building, (void*)(BG_SCREEN_ADDR(26)));
